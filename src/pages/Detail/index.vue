        ...
        <div class="InfoWrap">
          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="(spuSaleAttrm,index) in spuSaleAttrList" :key="spuSaleAttrm.id">
                <dt class="title">{{spuSaleAttrm.saleAttrName}}</dt>
                <dd changepirce="0" 
                @click="changeActive(spuSaleAttrValue,spuSaleAttrm.spuSaleAttrValueList)"
                :class="{active:spuSaleAttrValue.isChecked == 1}" 
                v-for="(spuSaleAttrValue,index) in spuSaleAttrm.spuSaleAttrValueList" :key="spuSaleAttrValue.id">
            ...
            <div class="cartWrap">
              <div class="controls">
                ...
                <a href="javascript:" class="plus" @click="skuNum<999?skuNum++:skuNum=999">+</a>
